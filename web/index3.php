  ...
  <body id="body">  
              ...
              <div class="from-group">
                ...
                <div class="input-group btn-group">
                  ...
                  <label class="btn btn-default">
                    Browse<input type="file" style="display: none;" name="berkas" id="berkas" onchange="return Filevalidation()">
                  </label>
                  <!--<button class="btn btn-default" type="button">Browse</button>-->
                    <button type="submit" class="btn btn-primary" role="button" name="upload">Submit</button>
                  </span>
                </div><!-- /input-group -->
              </div>
    ...
    <script>
      function Filevalidation(){
        ...
        var ekstensiOk = /(\.bin)$/i;
        if(!ekstensiOk.exec(pathFile)){
          alert('Silakan upload file yang dengan ekstensi .bin');
          inputFile.value = '';
          return false;
        }else{
